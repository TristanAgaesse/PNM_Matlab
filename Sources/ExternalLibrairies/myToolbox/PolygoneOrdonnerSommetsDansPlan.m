...
%   2D dans l'ordre trigonom�trique.
...
%Algo : on part du sommet S1 le plus � gauche. On prend S0 �
%   la verticale de S1 sur le bas.On calcule les produits scalaires 
%   <S0S1,SiS1> renormalis�s. Ils varient de 1 � -1 lorsqu'on fait le tour
%   des sommets dans l'ordre trigonom�trique (tous les sommets sont au
