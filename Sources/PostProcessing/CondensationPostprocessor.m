classdef CondensationPostprocessor
    ...
    methods
        ...
        function poreLookUpTable = BuildPoreLookUpTable(postProcessor,geometryRegions)
            ...
            %   [geometryRegions,geometryRegions3DIndex] = postProcessor.GetGeometryRegions_XYZDiscretized(infos_Discretization)
        ...
        function [geometryRegions,geometryRegions3DIndex] = GetGeometryRegions3DDiscretized(postProcessor,infos_Discretization)
            % Put
        ...
        function [geometryRegions,geometryRegions2DIndex] = GetGeometryRegions2DDiscretized(postProcessor,infos_Discretization)
            % Put
            % Input : postProcessor,infos_Discretization
            % Output : geometryRegions,geometryRegions3DIndex
            % Example : 
            ...
            %   infos_Discretization.X = [xmin,xmax];
            %   infos_Discretization.Y = [ymin,ymean,ymax];
            %   [geometryRegions,geometryRegions2DIndex] = postProcessor.GetGeometryRegions2DDiscretized(infos_Discretization)
