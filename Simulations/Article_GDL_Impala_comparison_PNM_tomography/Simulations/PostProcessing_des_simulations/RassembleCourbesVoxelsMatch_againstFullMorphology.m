...
figName={'../ResultsPNM/LocalMax1_theta115_voxelMatchTotal_againsFullMorpho.fig', ...
         '../ResultsPNM/LocalMax10_theta115_voxelMatchTotal_againsFullMorpho.fig', ...
         '../ResultsPNM/h2_theta115_voxelsMatch_againstFullMorpho.fig', ...
        '../ResultsPNM/h8_theta115_voxelsMatch_againstFullMorpho.fig' };
...
leg={'Pore Network distance between local max=1 theta=115°', ...
    'Pore Network distance between local max=10 theta=115°', ...
    'Pore Network H-maxima, H-contrast=2 theta=115°', ...
    'Pore Network H-maxima, H-contrast=8 theta=115°'};


legend(axe,leg)

title('Voxel match : simulation versus Full Morphology')